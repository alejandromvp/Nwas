...
<body id="page-top" style="background: #F2F2F2";>
  ...
  <!-- Navigation -->
 <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav" style="padding-bottom: 10px;">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive" >
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="../index.php">Noticias</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        ...
        <p><b>3.- poseer un mínimo de 60 partidas durante las 3 temporadas para al igual que el punto 1, evitar cuentas falsas (o smurfs) y 10 partidas durante la Última semana previa al torneo para participar.-</b></p>

        <p><b>4.- De ganar el Torneo, el pago se hara mediante saldo DE Matcherino!! esto lo recalco porque no habrán pagos DE NINGÚN TIPO A CUENTAS FUERA DE ESTE MEDIO.-</b></p>
  
        <p><b>5.- los primeros 2 lugares pasaran a la siguiente ronda del torneo que se hará a finales de año la cual se hará el choque de los mejores 24 e la temporada.-</b></p>

        <p><b>6.- ser respetuoso con los jugadores y administradores del evento, de no ser asi, no se fomentara el BadManner dejando vetado durante 5 fechas al proximo torneo y se le tendrá en consideración solamente si HAY QUE LLENAR ALGÚN CUPO VACÍO.-</b></p>
        ...
        <p><b style="color: #5005F2">medio de transmicion:</b> <a href="http://www.twitch.tv/themarte" style="text-decoration-line: underline;"><b>twitch.tv/themarte</b></a></p>
      ...
      <div id="caja_mensajes_div">
        ...
        <input type="text" id="mensaje" placeholder="Comentario" class="form-control">
    ...
    <aside class="col-md-4 blog-sidebar">
      ...
      <div class="p-3">
        <h4 class="font-italic">Noticias por mes</h4>
