...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0" style="color: #FFE814">Team Competitivo - Starcraft 2</p>
  ...
  <section class="page-section portfolio" id="portfolio">
    <div class="container">
      <img class="img-fluid" src="img/razas.png" alt="">
    </div>
      <!-- <div class="row">
        <div class="col-md-12 col-lg-12">
          <div class="text-center">
            <a class="btn btn-xl btn-outline-light" href="./roster.php">
              Ver Roster Completo
            </a>
          </div>
      </div>   
  ...
  <section class="page-section bg-primary text-white mb-0" id="about">
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase" style="color: #FFE814;">Quienes Somos</h2>
